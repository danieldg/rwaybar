...
Key | Expanded | Default | Details
----|----------|---------|--------
`format` | Yes | `%H:%M` | Time format using the strftime inspired date and time formatting [syntax](https://plot-rs.github.io/wasm32/chrono/format/strftime/index.html#specifiers)
